...
DarkSword Deploy  poc test  
  我们提供定制化的darksword （适用于iOS 18.4 - 18.7 ）漏洞利用链搭建,以及代码学习交流.
目前可以完整复现整个流程:landing page(落地页面) - rce_loader.js - rce_worker**.js-PE_main.js-收到Victim手机文件。
技术咨询   TG@leeyum211  200U

 We provide a complete setup environment and technical learning exchange platform for the DarkSword exploit chain (compatible with iOS 18.4 – 18.7).
